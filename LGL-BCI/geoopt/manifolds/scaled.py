...
from Net.geoopt import utils
from Net.geoopt.manifolds.base import Manifold, ScalingInfo
import functools
...
def rescale(function, scaling_info):
    ...
    def rescaled_function(self, *args, **kwargs):
        ...
        results = utils.make_tuple(results)
...
class Scaled(Manifold):
    ...
    # >>> import utils.geoopt, torch, numpy as np

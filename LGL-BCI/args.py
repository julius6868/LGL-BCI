...
def args_parser():
    ...
    parser.add_argument('--train_batch_size', type = int, default = 32, help = 'batch size in each epoch for trainning')
    ...
    parser.add_argument('--seed', type = int, default = 123, metavar='S', help = 'random seed (default: 1)') # (123) (12)
